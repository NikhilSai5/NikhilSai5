...
[![My Skills](https://skillicons.dev/icons?i=cpp,py,js,ts,html,css,react,nextjs,nodejs,django,bootstrap,solidity,tensorflow,opencv,postgres,mongodb,mysql,redis,aws,docker,git,githubactions,figma,postman,arduino&perline=13)](https://skillicons.dev)
